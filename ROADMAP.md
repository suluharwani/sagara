================================================================================
  ROADMAP PENGEMBANGAN WEB SAGARA - JERSEY PRINTING
  Langkah-Langkah Lengkap dengan Prompt AI Agent
================================================================================

Website: Sagara Jersey (Percetakan Kaos & Jersey Custom)
URL: http://127.0.0.1:8000/
Framework: CodeIgniter 4.5.5 + PHP 8.5 + MariaDB 12.3

================================================================================
  FASE 0: PERSIAPAN & SETUP AWAL
================================================================================

[TASK 0.1] Backup Database & Buat Migration untuk Tabel Baru
------------------------------------------------------------------------------------------
PROMPT:
"Buatkan migration CodeIgniter 4 untuk tabel-tabel baru yang dibutuhkan:
...
[TASK 0.2] Setup Konfigurasi Aplikasi
------------------------------------------------------------------------------------------
PROMPT:
"Edit file .env untuk menambahkan konfigurasi:
...
================================================================================
  FASE 1: E-COMMERCE CORE (Minggu 1-2)
================================================================================

[TASK 1.1] Halaman Produk Publik (Product Catalog)
------------------------------------------------------------------------------------------
PROMPT:
"Buatkan halaman katalog produk yang menampilkan semua produk dengan fitur:
...
[TASK 1.2] Sistem Harga & Detail Produk
------------------------------------------------------------------------------------------
PROMPT:
"Buatkan halaman detail produk yang menampilkan informasi lengkap:
...
[TASK 1.3] Keranjang Belanja (Shopping Cart)
------------------------------------------------------------------------------------------
PROMPT:
"Buatkan sistem keranjang belanja menggunakan session:
...
[TASK 1.4] Cart Helper Functions
------------------------------------------------------------------------------------------
PROMPT:
"Buatkan file app/Helpers/cart_helper.php dengan fungsi:
...
[TASK 1.5] Halaman Checkout
------------------------------------------------------------------------------------------
PROMPT:
"Buatkan halaman checkout dengan multi-step form:
...
================================================================================
  FASE 2: USER & AUTHENTICATION (Minggu 2)
================================================================================

[TASK 2.1] Registrasi Customer Manual
------------------------------------------------------------------------------------------
PROMPT:
"Buatkan sistem registrasi customer manual:
...
[TASK 2.2] Login Customer Manual
------------------------------------------------------------------------------------------
PROMPT:
"Buatkan sistem login customer manual:
...
[TASK 2.3] Customer Dashboard
------------------------------------------------------------------------------------------
PROMPT:
"Buatkan dashboard customer setelah login:
...
================================================================================
  FASE 3: PAYMENT & ORDER (Minggu 2-3)
================================================================================

[TASK 3.1] Payment Gateway Integration (Midtrans)
------------------------------------------------------------------------------------------
PROMPT:
"Buatkan integrasi payment gateway Midtrans:
...
[TASK 3.2] Order Self-Service System
------------------------------------------------------------------------------------------
PROMPT:
"Buatkan sistem order self-service oleh customer:
...
[TASK 3.3] Tracking Order Publik
------------------------------------------------------------------------------------------
PROMPT:
"Buatkan halaman tracking order publik:
...
================================================================================
  FASE 4: SHIPPING & LOGISTICS (Minggu 3)
================================================================================

[TASK 4.1] Integrasi RajaOngkir API
------------------------------------------------------------------------------------------
PROMPT:
"Buatkan integrasi ongkos kirim RajaOngkir:
...
[TASK 4.2] Fitur Upload Desain Custom
------------------------------------------------------------------------------------------
PROMPT:
"Buatkan fitur upload desain custom oleh customer:
...
================================================================================
  FASE 5: MARKETING & ENGAGEMENT (Minggu 3-4)
================================================================================

[TASK 5.1] WhatsApp Integration
------------------------------------------------------------------------------------------
PROMPT:
"Buatkan integrasi WhatsApp:
...
[TASK 5.2] Discount & Coupon System
------------------------------------------------------------------------------------------
PROMPT:
"Buatkan sistem kupon diskon:
...
METHOD CUSTOMER:
- apply() - POST apply kupon ke checkout
- remove() - hapus kupon dari checkout

METHOD ADMIN:
- index() - daftar kupon
- create() - buat kupon baru
- store() - POST simpan kupon
- edit($id) - edit kupon
- update($id) - POST update kupon
- delete($id) - hapus kupon
...
[TASK 5.3] Invoice PDF Generator
------------------------------------------------------------------------------------------
PROMPT:
"Buatkan generator invoice PDF:
...
================================================================================
  FASE 6: REPORTING & ANALYTICS (Minggu 4)
================================================================================

[TASK 6.1] Dashboard Admin Enhanced
------------------------------------------------------------------------------------------
PROMPT:
"Buatkan dashboard admin yang lebih informatif:
...
[TASK 6.2] Laporan Keuangan
------------------------------------------------------------------------------------------
PROMPT:
"Buatkan halaman laporan keuangan:
...
================================================================================
  FASE 7: SECURITY & OPTIMIZATION (Minggu 4)
================================================================================

[TASK 7.1] Rate Limiting & Security
------------------------------------------------------------------------------------------
PROMPT:
"Buatkan fitur keamanan tambahan:
...
------------------------------------------------------------------------------------------
PROMPT:
"Buatkan library optimasi gambar:
...
================================================================================
  FASE 8: DEPLOYMENT & TESTING (Minggu 4-5)
================================================================================

[TASK 8.1] Testing
------------------------------------------------------------------------------------------
PROMPT:
"Buatkan test suite untuk fitur baru:
...
================================================================================
  PROMPT UNTUK AI AGENT - EKSEKUSI END-TO-END
================================================================================

PROMPT 1 (FASE 0 - PERSIAPAN):
"Implement TASK 0.1 dan 0.2 dari roadmap. Buat migration untuk tabel baru dan setup konfigurasi. Pastikan semua migration berhasil dijalankan dengan php spark migrate."

PROMPT 2 (FASE 1 - E-COMMERCE CORE):
"Implement TASK 1.1 sampai 1.5 dari roadmap. Buat halaman katalog produk, detail produk, keranjang belanja, dan checkout. Pastikan semua fitur berjalan dengan baik dan responsive."

PROMPT 3 (FASE 2 - USER & AUTH):
"Implement TASK 2.1 sampai 2.3 dari roadmap. Buat registrasi customer manual, login manual, dan dashboard customer. Integrasikan dengan Google OAuth yang sudah ada."

PROMPT 4 (FASE 3 - PAYMENT & ORDER):
"Implement TASK 3.1 sampai 3.3 dari roadmap. Buat integrasi Midtrans, order self-service, dan tracking publik. Test dengan sandbox Midtrans."

PROMPT 5 (FASE 4 - SHIPPING):
"Implement TASK 4.1 dan 4.2 dari roadmap. Buat integrasi RajaOngkir dan upload desain custom. Pastikan kalkulasi ongkir akurat."

PROMPT 6 (FASE 5 - MARKETING):
"Implement TASK 5.1 sampai 5.3 dari roadmap. Buat integrasi WhatsApp, sistem kupon, dan invoice PDF. Test generate PDF."

PROMPT 7 (FASE 6 - REPORTING):
"Implement TASK 6.1 sampai 6.3 dari roadmap. Buat dashboard enhanced, laporan keuangan, dan optimasi SEO. Test export Excel dan PDF."

PROMPT 8 (FASE 7 - SECURITY):
"Implement TASK 7.1 dan 7.2 dari roadmap. Buat rate limiting dan optimasi gambar. Pastikan keamanan terjaga."

PROMPT 9 (FASE 8 - DEPLOYMENT):
"Implement TASK 8.1 dan 8.2 dari roadmap. Buat test suite dan jalankan deployment checklist. Pastikan semua test pass."

================================================================================
  CATATAN PENTING UNTUK AI AGENT
================================================================================

⚠️  SETELAH SETIAP TASK:
