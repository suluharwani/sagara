...
$(document).ready(function() {
	tinymce.init({
        ...
        images_upload_url: base_url + 'content/upload_image',  
        ...
        images_upload_handler: function (blobInfo, success, failure) {
            ...
            $.ajax({
                url: base_url + 'content/upload_image',
                type: 'POST',
                data: formData,
                processData: false,
                contentType: false,
...
$('.tambah').on('click', function() {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            $.ajax({
                type: "POST",
                url: base_url + 'content/add_konten',  
                data: {
...
$(document).on('click', '.edit', function() {
    ...
    $.ajax({
        url: base_url + 'content/get_konten/' + kontenId,
        method: 'GET',
        dataType: 'json',
            ...
            Swal.fire({
                ...
                html: `
                    <form id="form_edit_data">
                        ...
                        <div class="form-group">
                            <label for="body">Konten</label>
                            <textarea class="form-control" id="body">${konten.body}</textarea>
                        </div>
                    </form>
                `,
                didOpen: () => {
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: base_url + 'content/update_konten',
                        data: {
                            id: result.value.id,
                            title: result.value.title,
                            body: result.value.body
    ...
    $(document).on('click', '.delete', function() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    type: "POST",
                    url: base_url + '/content/delete_konten/' + kontenId,
                    success: function() {
