...
$(document).ready(function() {
	tinymce.init({
        ...
        images_upload_url: base_url + 'informasi/upload_image',  // URL untuk mengunggah gambar
        ...
        images_upload_handler: function (blobInfo, success, failure) {
            ...
            $.ajax({
                url: base_url + 'informasi/upload_image',
                type: 'POST',
                data: formData,
                processData: false,
                contentType: false,
  ...
  var dataTable = $('#tabel_serverside').DataTable({
    ...
    "scrollX": true,
    "ajax": {
      "url": base_url + "informasi/get_list",
      "type": "post",
      "dataType": 'json',
      "data": {},
    },
    ...
    Swal.fire({
        ...
        didOpen: () => {
            ...
            tinymce.init({
                ...
                plugins: 'image code link',
                toolbar: 'undo redo | image | link | code',
                images_upload_url: base_url + 'informasi/upload_image',
                automatic_uploads: true,
            });
        },
        ...
        if (result.isConfirmed) {
            ...
            $.ajax({
                type: "POST",
                url: base_url + 'informasi/add',  // URL endpoint untuk menambah konten
                data: {
...
$(document).on('click', '.edit', function() {
    ...
    $.ajax({
        url: base_url + 'informasi/get/' + kontenId,
        method: 'GET',
        dataType: 'json',
    ...
    $(document).on('click', '.delete', function() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    type: "POST",
                    url: base_url + '/informasi/delete/' + kontenId,
                    success: function() {
