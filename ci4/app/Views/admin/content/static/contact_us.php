    ...
    <div class="modal-body">
        <form id="form"  class="form" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="nama_contact" class="form-control" id="nama_contact" >
            </div>
            <div class="mb-3">
  ...
  <div class="modal-dialog modal-xl">
    ...
    <div class="modal-body">
        <form id="formUpdateText"  class="formUpdateText" >
            ...
            <div class="mb-3">
                <label for="nama_contact" class="form-label">Nama Contact</label>
                <input type="text" name="nama_contact" class="form-control editVal" id="nama_contact" >
            </div>
           <div class="mb-3">
            <label for="contact" class="form-label">Contact</label>
            <input type="text" name="contact" class="form-control editVal" id="contact" >
        </div>
        <div class="mb-3">
            <label for="link" class="form-label">Link</label>
