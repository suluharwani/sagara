  ...
  <div class="modal-dialog modal-xl">
    ...
    <div class="modal-body">
        <form id="form"  class="form" enctype="multipart/form-data">
         ...
         <div class="mb-3">
            <label for="text" class="form-label">Main Text</label>
            <textarea class="summernote" name="text" inputVal = "text" id="text" cols="30" rows="10"></textarea>

        </div>
        <div class="mb-3">
            <label for="text_footer" class="form-label">Footer</label>
            <input type="text" name="text_footer" class="form-control" id="text_footer" >
        </div>
    </form>
  ...
  <div class="modal-dialog modal-xl">
    ...
    <div class="modal-body">
        <form id="formUpdateText"  class="formUpdateText" >
            <input type="text" name="id" class="editVal" hidden id="id" >
            <div class="mb-3">
                <label for="nama" class="form-label">Nama</label>
            ...
            <div class="mb-3">
                <label for="text_footer" class="form-label">Footer</label>
                <input type="text" name="text_footer" class="form-control editVal" id="text_footer" >
            </div>
        </form>
