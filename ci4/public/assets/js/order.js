            ...
            { mRender: function (data, type, row) {
                ...
                return `<div class="btn-group btn-group-sm" role="group" aria-label="Aksi order">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end shadow">
                        ...
                        <li><button type="button" class="dropdown-item printShipment" data-id="${orderId}"><i class="fas fa-truck me-2"></i>Label pengiriman</button></li>
...
$(document).on('click', '.printShipment', function () {
  printpengirimanPDF($(this).data('id'));
});
